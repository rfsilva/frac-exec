...
- Name: 04-availability-drawer.spec.ts >> Widget e Drawer de Disponibilidade >> Dashboard exibe widget de disponibilidade
- Location: tests/04-availability-drawer.spec.ts:44:7
...
Locator: .widget-card, text=Disponibilidade
Expected: visible
Error: Unexpected token "=" while parsing css selector ".widget-card, text=Disponibilidade". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 8000ms
  - waiting for .widget-card, text=Disponibilidade
...
- generic [ref=e2]:
  ...
  - generic [ref=e50]:
    - banner "Selo FracExec" [ref=e52]:
      - generic [ref=e53]: ✦
      - generic [ref=e54]:
        - generic [ref=e55]: avail.e2e.1780515627164
    ...
    - generic [ref=e60]:
      - complementary "Menu de navegação" [ref=e61]:
        - generic [ref=e62]:
          - generic [ref=e63]: AV
          - generic [ref=e64]:
            - generic [ref=e65]: avail.e2e.1780515627164
