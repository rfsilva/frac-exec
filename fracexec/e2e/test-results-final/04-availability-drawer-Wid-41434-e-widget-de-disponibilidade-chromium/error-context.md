...
- Location: tests/04-availability-drawer.spec.ts:46:7
...
Locator: locator('.widget-card').or(getByText('Disponibilidade').first())
Expected: visible
Error: strict mode violation: locator('.widget-card').or(getByText('Disponibilidade').first()) resolved to 2 elements:
    1) <div class="widget-card" _ngcontent-ng-c190752370="">…</div> aka getByText('Disponibilidade20 / 20Editar')
    2) <h2 class="widget-title" _ngcontent-ng-c190752370="">Disponibilidade</h2> aka getByRole('heading', { name: 'Disponibilidade' })

Call log:
  - Expect "toBeVisible" with timeout 15000ms
  - waiting for locator('.widget-card').or(getByText('Disponibilidade').first())
...
- generic [ref=e4]:
  - banner "Selo FracExec" [ref=e6]:
    - generic [ref=e7]: ✦
    - generic [ref=e8]:
      - generic [ref=e9]: avail.e2e.1780692368378
  ...
  - generic [ref=e14]:
    - complementary "Menu de navegação" [ref=e15]:
      - generic [ref=e16]:
        - generic [ref=e17]: AV
        - generic [ref=e18]:
          - generic [ref=e19]: avail.e2e.1780692368378
